...
function Footer() {
  return (
    <footer className='w-screen bg-[#577C3A] text-white pt-[40px] pb-0 flex flex-col space-y-5'>
      <div className='flex items-start justify-center space-x-6'>
        ...
        <div className='flex flex-col justify-start items-start space-y-4 max-w-[210px]'>
          ...
          <div className='flex items-center justify-start space-x-4'>
            ...
            <span className='underline'>18001202424</span>
          </div>
          <div>Follow us</div>
          <ul className='flex justify-start items-center space-x-4 text-xl'>
      ...
      <div className='flex justify-center items-center text-sm p-[30px] border border-t-1 space-x-4'>
        <span>
